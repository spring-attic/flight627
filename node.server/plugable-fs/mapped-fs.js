...
var stringUtil = require('./utils/strings');

var pathNormalize = pathUtil.pathNormalize;
var pathResolve = pathUtil.pathResolve;
var pathIsPrefixOf = pathUtil.pathIsPrefixOf;
var pathJoin = pathUtil.pathJoin;
var startsWith = stringUtil.startsWith;
